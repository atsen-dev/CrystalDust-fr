...
const u8 gText_MatchCallCoolTRAINER_BROOKE_OLD_Strategy[] = _("Bien connaître l'ennemi.");
const u8 gText_MatchCallCoolTRAINER_BROOKE_OLD_Pokemon[] = _("L'équilibre est essentiel.");
const u8 gText_MatchCallCoolTRAINER_BROOKE_OLD_Intro1[] = _("Je veux devenir le");
const u8 gText_MatchCallCoolTRAINER_BROOKE_OLD_Intro2[] = _("MAITRE PKMN.");
