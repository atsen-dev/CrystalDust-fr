...
const u8 gText_EggNickname[] = _("ŒUF");
const u8 gText_Pokemon[] = _("POKéMON");
const u8 gText_ProfBirchMatchCallName[] = _("PROF. SEKO");
const u8 gText_MainMenuNewGame[] = _("NOUVEAU JEU");
const u8 gText_MainMenuContinue[] = _("CONTINUER");
const u8 gText_MainMenuOption[] = _("OPTIONS");
const u8 gText_MainMenuMysteryGift[] = _("CADEAU MYSTERE");
const u8 gText_MainMenuMysteryGift2[] = _("e-CADEAU MYSTERE");
const u8 gText_MainMenuMysteryEvents[] = _("EVENEMENT MYSTERE");
...
const u8 gText_WirelessNotConnected[] = _("L'Adaptateur Sans-fil n'est\n pas connecté.");
...
const u8 gText_OakBoy[] = _("GARCON");
const u8 gText_OakGirl[] = _("FILLE");
...
const u8 gText_SearchCompleted[] = _("Recherche terminé.");
...
const u8 gText_ReturnToPokedex[] = _("Retourner au POKéDEX.");
const u8 gText_SelectPokedexMode[] = _("Sélectionner le mode POKéDEX.");
...
const u8 gText_WelcomeToHOF[] = _("Bienvenue au HALL OF FAME!");
const u8 gText_HOFDexRating[] = _("Spotted POKéMON: {STR_VAR_1}!\nOwned POKéMON: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
const u8 gText_HOFDexSaving[] = _("Sauvegarde…\nNE PAS ETEINDRE.");
const u8 gText_HOFCorrupted[] = _("Les données du HALL OF FAME sont corrompues.");
...
const u8 gText_BirchInTrouble[] = _("PROF. SEKO est dans la merde!\nEnvoi un POKéMON et sauve le!"); // TODO lol
//const u8 gText_BirchInTrouble[] = _("PROF. SEKO est en danger!\nEnvoi un POKéMON et sauve le!"); // TODO lol
...
const u8 gMenuText_Check[] = _("VERIFIER");
const u8 gText_None[] = _("AUCUN");
const u8 gMenuText_Deselect[] = _("DESELECTIONNER");
...
const u8 gText_Coins[] = _("PIECES");
const u8 gText_Var1Coins[] = _("{STR_VAR_1} PIECES");
...
const u8 gText_NoPokemon[] = _("Vous n'avez pas de\nPOKéMON.");
...
const u8 gText_ItemStorage[] = _("STOCKAGE D'OBJETS");
const u8 gText_Mailbox[] = _("BOITE AUX LETTRES");
...
const u8 gText_ProfOakSPc[] = _("PROF. CHEN's PC");
...
const u8 gText_MenuOptionPokegear[] = _("POKéMATOS");
...
const u8 gText_WhatWouldYouLikeToDo[] = _("Que voulez-vous faire?"); // Unused
...
const u8 gText_CyndaquilDoll80BP[] = _("HERICENDRE DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_ChikoritaDoll80BP[] = _("GERMIGNON DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_TotodileDoll80BP[] = _("KAIMINUS DOLL{CLEAR_TO 0x5E}80BP");
...
const u8 gText_AlreadySavedFile_Chat[] = _("Il y a déjà une sauvegarde.\nLa remplacer?");
const u8 gText_SavingDontTurnOff_Chat[] = _("SAUVEGARDE…\nNE PA ETEINDRE.");
...
const u8 gText_TextSpeed[] = _("VITESSE DE TEXTE");
const u8 gText_BattleScene[] = _("ANIMATION COMBAT");
...
const u8 gText_ButtonMode[] = _("IMPRIMER");
...
const u8 gText_MenuPokegear[] = _("POKéMATOS");
...
const u8 gText_Swap[] = _("ECHANGE");
const u8 gText_Summary2[] = _("SOMMAIRE");
...
ALIGNED(4) const u8 gText_Communicating[] = _("Communication…");
...
const u8 gText_MoveRelearnerPower[] = _("FORCE/");
...
const u8 gText_SetClock_WhatTime[] = _("Quelle heure est-il?");
const u8 gText_SetClock_Whoa[] = _("Woaw! {STR_VAR_1}?");
...
const u8 gText_SetClock_Midnight[] = _("Il est minuit");
const u8 gText_SetClock_Noon[] = _("Il est midi");
...
// Pokégear
const u8 gText_PokegearInstructions[] = _("Appuyez sur {START_BUTTON} et {SELECT_BUTTON} pour\nmodifier. B pour quitter.");
...
// Radio stations
const u8 gText_OaksPkmnTalk[] = _("CHEN's {PKMN} Talk");
...
// Oak's Pokemon Talk
const u8 gText_OaksPkmnTalkIntro1[] = _("MARY: PROF. CHEN'S");
const u8 gText_OaksPkmnTalkIntro2[] = _("POKéMON TALK!");
const u8 gText_OaksPkmnTalkIntro3[] = _("With me, MARY!");
const u8 gText_OaksPkmnTalk1[] = _("CHEN: {STR_VAR_1}");
...
const u8 gText_OPTAdjectiveWeird[] = _("bizarre.");
...
const u8 gText_OPTAdjectiveExciting[] = _("excitant.");
const u8 gText_OPTAdjectiveGroovy[] = _("groovy!");
const u8 gText_OPTAdjectiveInspiring[] = _("inspirant.");
const u8 gText_OPTAdjectiveFriendly[] = _("familié.");
const u8 gText_OPTAdjectiveHotHotHot[] = _("hot, hot, hot!");
const u8 gText_OPTAdjectiveStimulating[] = _("stimulant.");
...
const u8 gText_LuckyChannel11[] = _("the TOUR RADIO!");
...
const u8 gText_BuenasPassword7[] = _("TOUR RADIO!");
